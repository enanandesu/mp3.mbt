...
repository = "https://github.com/enanandesu/mp3.mbt"
...
warnings = "-deprecated-deprecated_syntax-implicit_impl_as_method-test_unqualified_package-fragile_catch_all"
